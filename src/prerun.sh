...
#       If the ca-certificate already exists on the host, it builds and runs the system
#       It also opens the websites and gives you the password
#       .
...
if [ -f $CA_FILE ]; then
        ...
        sleep 10
        xdg-open https://git.bench.test/
        xdg-open https://drone.bench.test/
        clear
